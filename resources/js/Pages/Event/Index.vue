        ...
        <div class="py-12">
            <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
                ...
                >
                    ...
                    <Link
                        :href="route('events.create')"
                        class="inline-block px-6 py-3 bg-gradient-to-r from-blue-600 to-cyan-600 hover:from-blue-700 hover:to-cyan-700 rounded-lg font-semibold text-white shadow-lg shadow-blue-500/30 transition-all duration-200 transform hover:scale-[1.02]"
                    >
